            ...
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
                ...
                <Card className="w-full max-w-sm text-center">
                    <CardContent className="pt-6 space-y-3">
                        ...
                        <Link href='/login' className="text-brand text-sm hover:underline block mt-4">Back to sign in</Link>
                    </CardContent>
                </Card>
            </div>
        )
            ...
            <CardContent>
                <form onSubmit={handleSignup} className="space-y-4">
                    <div className="space-y-1 5">
                        ...
                        <Input id="fullName" type="text" value={fullName} onChange={e => setFullName(e.target.value)} placeholder="Dr. Amaka Okafor" required autoFocus className="field"/>
                    </div>
